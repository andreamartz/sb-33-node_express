...
<html lang="en">
 <head>
  ...
  <link href="/media/css/fontawesome.css?24a48d20" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?24a48d20">
      ...
      <div class="text">
        <ul>
            ...
            <li class=" non-badged">
              ...
              2020-12-08 &ndash; 2020-12-09 &middot; <a href="/about/event/postgres-build-2020-a-virtual-conference-2399/">Postgres Build 2020: A Virtual Conference</a>
            </li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgpool-ii-420-is-now-released-2122/">Pgpool-II 4.2.0 is now released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-27 by Pgpool Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgagroal-100-2121/">pgagroal 1.0.0</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-25 by Red Hat</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbadger-v114-released-2120/">pgBadger v11.4 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-24 by Gilles Darold</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-november-22-2020-2119/">PostgreSQL Weekly News - November 22, 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-23 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbouncer-1150-released-2118/">PgBouncer 1.15.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2020-11-21 by Peter Eisentraut</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Z2"> Postgres dress with pockets</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Lætitia AVROT</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-11-27</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Z1"> 2020: Online Conferences</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Z0"> Setting up PostgreSQL for Debezium</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Michał Mackiewicz</li>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Y_"> PostgreSQL High Availability: Setup and Uptime Considerations</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4YZ"> Using Postgres for Statistics: Centering and Standardizing Data</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Steven Pousty</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-11-25</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4Y-"> Calling a Stored Procedure in PostgrSQL from JAVA and its Current Limitations</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4YX"> Insert-only data modelling to smooth peaks on slow disks</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4YW"> How to limit rows to at most N per category</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#39;depesz&#39; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-11-24</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/4YT"> Postgres: The batteries included database</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Craig Kerstiens</li>
              <li><i class="far fa-clock"></i>&nbsp;2020-11-23</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?24a48d20"></script>
